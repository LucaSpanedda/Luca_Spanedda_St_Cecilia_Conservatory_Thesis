...
\begin{center}
    \includegraphics[width=10cm]{figures/LorenzSystemInside.pdf} \\
    {Topologia dell'Algoritmo del Sistema di Lorenz Discreto} \\ 
\end{center}
\vspace{0.5cm}

\begin{center}
    \includegraphics[width=14cm]{figures/LorenzSystemFB1.pdf} \\
    {Topologia del Feedback delle Equazioni del Sistema di Lorenz Discreto} \\ 
\end{center}
\vspace{0.5cm}
...
\begin{center}
    ...
    {Topologia del Feedback delle Equazioni del Sistema di Lorenz Modificato con DC-blocker e TanH} \\ 
\end{center}
\vspace{0.5cm}

\begin{center}
    \includegraphics[width=14cm]{figures/DCblocker.pdf} \\
    {Topologia dell'Algoritmo DC-blocker} \\ 
\end{center}
\vspace{0.5cm}

\begin{center}
    \includegraphics[width=10cm]{figures/Saturator.pdf} \\
    {Topologia dell'Algoritmo TanH} \\ 
\end{center}
\vspace{0.5cm}
...
e provengono dal libro "The Art of VA Filter Design" di Vadim Zavalishin, 
...
"Virtual Analog (VA) Filter Implementation and Comparisons v2.0"
...
\begin{center}
    ...
    {Topologia del Feedback delle Equazioni del Sistema di Lorenz Modificato con Filterbank} \\ 
\end{center}
\vspace{0.5cm}

\begin{center}
    \includegraphics[width=14cm]{figures/BPFilterBank.pdf} \\
    {Topologia del Filterbank con i filtri Bandpass SVF TPT} \\ 
\end{center}
\vspace{0.5cm}
