...
\begin{center}
    ...
    {Topologia del normalizzatore di picco tramite \textit{Peakholder} ad 1 campione di ritardo}} \\ 
\end{center}
\vspace{0.5cm}
...
dove \( k_{1} = {0.001}^{\frac{(\frac{1}{(SR)})}{T}} \) è la formula del decadimento RT60, 
e dove T rappresenta il tempo di decadimento desiderato in secondi, mentre
\textit{SR} rappresenta la costante della frequenza di campionamento utilizzata.
...
\begin{center}
    ...
    {Topologia del \textit{Peakenvelope} con Decay RT60}} \\ 
\end{center}
\vspace{0.5cm}
...
\begin{center}
    ...
    {Topologia del \textit{Peakholder} (adattivo) con Timer}} \\ 
\end{center}
\vspace{0.5cm}
\clearpage
...
alcune modalità e relazioni possibili per rendere un sistema 
...
e i meccanismi adattivi per mantenere il sistema in una condizione di stabilità
...
delle altre unità che compongono nella loro interezza il brano.