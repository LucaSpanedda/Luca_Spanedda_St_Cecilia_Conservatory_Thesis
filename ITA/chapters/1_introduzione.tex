...
\todo[inline,color=green]{tutta la parte precedente è eccessivamente superficiale, non contestualizza nulla. trova il modo di iniziare da qui}
...
che mentre \todo[inline,color=green]{se apri un mentre non puoi chiudere la frase con il punto}  nel primo periodo lo studioso di cibernetica (di primo ordine)
...
\todo[inline,color=green]{svariati compositori è un modo di parlare estremamente colloquiale che stride ancora di più su carta. }
...
\todo[inline,color=green]{ex allievo… ex è una parola separata da allievo, in generale non ha senso introdurre dati circostanziali quando parli di persone… in teoria dovresti usare i nomi senza riferimenti a te o tra loro. Se vuoi dire che ha studiato con lui dillo semplicemente. che sia stato un suo studente sta scritto ovunque.}
...
\todo[inline,color=green]{ce poi il caso… Luca! Santo cielo, è Michelangelo. C'è Poi?… direi che puoi fare molto meglio con molte meno parole.}
...
\todo[inline,color=green]{non vorrei essere citato in questa tua relazione, sono relatore. in ogni caso se poi mi metti vicino a valle potrei anche non farti laureare. per inciso: credevo stessi parlando di musica}
...
\todo[inline,color=green]{sempre in linea generale: usi troppi riferimenti personali, commenti o aggettivi che non semplificano la lettura. La storia, scritta così, risulta estremamente soggettivizzata, oltre quello che già di suo è nello scrivere una storia. inoltre non vai per un percorso cronologico lineare, ti trovi alla fine del percorso a fare salti di venti anni precedenti a dove eri qualche riga prima. anche questo non semplifica. se non è l'ordine cronologico quello che vuoi seguire, procedi per concetti e relazioni, ma rendi chiaro cosa si collega a chi }
