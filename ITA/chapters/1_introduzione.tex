...
l'uso di sistemi di \emph{feedback} 

% \todo[inline,color=green]{sarebbe opportuno mettere in un campo \emph{} le parole che lasci in inglese e che non sono in uso nella lingua italiana} 

e la rilevanza dei circuiti informativi chiusi
...
del magnetofono, mediante retroazione \emph{(feedback)} fra le testine di riproduzione e 
...
estensivamente con sistemi di autoregolazione basati su \emph{feedback loop},
...
%\todo[inline,color=green]{LUCA! le citazioni sono le perle di un testo di tesi. 
%tu scegli le parole degli altri che vuoi mettere tra le tue! 
%cristo santo centrate in corsivo come se fosse un biglietto degli auguri di natale! LUCA!!!! ! ! !}
%
%\begin{center}
%\vspace{0.5cm}
...
che sfruttano sistemi di \emph{feedback}, fra i più rilevanti:
...
basato su \emph{feedback} complessi, per la realizzazione di Variations II (1960) di John Cage,
...
al corno francese e' collegata una console che si sintonizza sul \emph{feedback} 
...
dando vita nel loro insieme ad un processo molto lento di \emph{feedback} positivo dove
...
sposta il tono del \emph{feedback} elettoacustico su una frequenza di risonanza
...
nei confronti del fenomeno di \emph{feedback} si stia avvicinando ad una logica più vicina
...
Inoltre, c'è da considerare il caso molto importante di Michelangelo Lupone, 
il maestro di Agostino Di Scipio, noto per i suoi lavori di \emph{feedback} sulla materia che, 
nel corso degli anni '90, portarono allo sviluppo di strumenti aumentati in \emph{feedback} come il Feed-Drum, 
innovativo strumento elettroacustico a percussione.
Di Scipio e Lupone si sono interessati alle questioni sul \emph{feedback} in contemporanea, 
...
Fractus, per viola e supporto digitale.
...
tecniche per lavorare con il \emph{feedback} e i sistemi autonomi.
...
Il primo a introdurre il concetto di \emph{feedback} nella letteratura scientifica 
...
tuttavia in molti preferiscono conservare direttamente la parola inglese \emph{feedback}. 

Nella teoria cibernetica, e in genere in tutte le discipline scientifiche che usano approcci di tipo sistemico, 
quando il \emph{feedback} ha un effetto risultante dall’azione di un sistema (meccanismo, circuito, organismo ecc.) 
...
Esistono sostanzialmente due tipi di retroazione nel \emph{feedback}: \textit{positiva} e \textit{negativa}.
Il \emph{feedback} è generalmente detto negativo quando agisce in modo che il sistema funzioni sempre allo stesso modo, 
...
riguardo le possibili proprietà del \emph{feedback}, affrontando queste di volta in volta
nei casi specifici.
Per anticipare da ora alcuni esempi: 
ci basti pensare che nel controllo di un sistema complesso
come può essere quello del \emph{feedback} elettroacustico,
in un modello dove si possono introdurre delle linearità 
tramite retroazione all'interno del ciclo di
\emph{feedback}, questo potrebbe ad esempio voler dire costringere la complessità
...
In sintesi, il principio del \emph{feedback} continua a essere un pilastro fondamentale nella storia 
